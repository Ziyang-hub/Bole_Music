...
- 💬 **陪你聊音乐**：四种 AI 人格可选（文艺诗人/专业乐评人/暖心朋友/幽默伙伴），多对话窗口，多轮对话
- 🎤 **哼歌识曲**：哼一段旋律 → 实时波形 + 识别结果确认卡片
- 🔗 **打通网易云**：粘贴歌曲/歌单链接自动解析，应用内搜索歌曲、批量导入歌单
- 📊 **生成听歌报告**：日/周/月报告，AI 一键生成文字总结，可复制分享
- 📝 **记录听歌日记**：自动保存分析过的歌曲，可编辑笔记、AI 生成每日小结、一键导出
- 🎨 **桌面体验**：侧边栏收起/展开动画、实时音量波形、多对话滚动位置记忆
...
| 页面 | 功能 |
|------|------|
| 💬 知音对话 | 多对话窗口 + 四种人格，输入歌名 / 粘贴链接 / 🔍搜索 / 📋歌单 / 🎤哼歌，与 AI 伯乐交流；右侧"—"浏览栏快速跳转历史提问 |
| 📊 听歌报告 | 统计卡片、曲风分布、热门排行、日/周/月 AI 报告（时间段过滤 + 前50首歌） |
| 📝 听歌日记 | 时间线展示，可编辑笔记，AI 生成每日小结，一键导出 |
| ⚙️ 设置 | 配置 API Key、AI 人格（4 种）、主题切换、音频采集权限 |
...
| 音频采集 | macOS ScreenCaptureKit（Swift helper，蓝牙耳机零降级）/ Windows WASAPI / Linux PulseAudio |
| 音乐平台 | NeteaseCloudMusicApi |
| 安全 | DOMPurify 消毒 + IPC 白名单 + SSRF 防护 + CSP 收紧 |
| 打包 | electron-builder |
